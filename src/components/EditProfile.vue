        ...
        <div class="gender">
          <div class="gender-item">
            ...
            <label for="man"><svg width="20" height="20" viewBox="0 0 48 48" fill="none"
                ...
                <path d="M41.9517 15.0483V6.04834H32.9517" stroke="#8cafff" stroke-width="4" stroke-linecap="round"
                ...
                <path d="M30.0002 17.9999L39.9517 8.04838" stroke="#8cafff" stroke-width="4" stroke-linecap="round"
                  stroke-linejoin="round" />
              </svg>男</label>
          </div>
          <div class="gender-item">
            ...
            <label for="woman"><svg width="20" height="20" viewBox="0 0 48 48" fill="none"
                ...
                <g clip-path="url(#icon-77eca05bbccbbd09)">
                  ...
                  <path d="M18.4642 29.5353L5.73633 42.2632" stroke="#ff8cec" stroke-width="4" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M19.1714 41.5562L6.44346 28.8282" stroke="#ff8cec" stroke-width="4" stroke-linecap="round"
                    stroke-linejoin="round" />
                </g>
                <defs>
